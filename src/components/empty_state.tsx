      ...
      <div className="text-center">
        ...
        {actionText && actionPath && (
          <button
            ...
            className="bg-gradient-to-r from-[#1DB954] to-[#1ed760] text-white py-2 px-6 rounded-lg font-medium hover:from-[#1ed760] hover:to-[#1DB954] focus:outline-none focus:ring-2 focus:ring-[#1DB954] focus:ring-offset-2 transition-all duration-200"
          >
            {actionText}
          </button>
        )}
