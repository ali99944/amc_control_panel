...
import { termsConditionsFormSchema, type TermsConditionsFormData } from "./terms-conditions-form-schema"

import TermsSectionForm from "./terms-section-form"
...
interface TermsConditionsFormProps {
  ...
  onSubmit: (data: TermsConditionsFormData) => void
  isLoading?: boolean
}

export default function TermsConditionsForm({ initialData, onSubmit, isLoading = false }: TermsConditionsFormProps) {
  const {
    control,
    handleSubmit,
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <div className="bg-white p-6 rounded-lg border border-gray-200">
        <h3 className="text-lg font-medium text-gray-900 mb-4">معلومات الشروط والأحكام</h3>
        <Input
          {...register("title")}
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h3 className="text-lg font-medium text-gray-900">أقسام الشروط والأحكام</h3>
